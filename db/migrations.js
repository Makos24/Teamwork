...
db.none(
  "CREATE TABLE IF NOT EXISTS session(sessionguid UUID NOT NULL, created text NOT NULL, sessionlife integer NOT NULL)"
)
  .then(data => {
...
db.none(
  "CREATE TABLE IF NOT EXISTS users(id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, email text UNIQUE NOT NULL, role integer NOT NULL, created_at timestamp default current_timestamp)"
)
  .then(data => {
